...
```
One can import the module and use the available methods to run analysis. Related type descriptions can be seen [here](https://github.com/remix-project-org/remix-project/blob/master/libs/remix-analyzer/src/types.ts).
...
If you'd like to add some code, please take a look at our contribution guidelines [here](https://github.com/remix-project-org/remix-project/blob/master/CONTRIBUTING.md). Reach us on [Discord](https://discord.gg/MzhfCGstNA) in case of any queries.
