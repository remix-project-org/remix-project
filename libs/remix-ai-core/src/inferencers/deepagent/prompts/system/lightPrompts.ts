...
export const SUPABASE_SUBAGENT_PROMPT = 'Supabase Specialist: Access to the following tools: supabase_list_tables, supabase_get_table_schema, supabase_create_table, supabase_drop_table, supabase_query_rows, supabase_insert_rows, supabase_enable_rls, supabase_list_buckets, supabase_create_bucket'
