...
export function ContractWizard () {
  ...
  return (
    <section className="container mx-auto px-4-fluid">
      <div className="row g-3">
        <div className="col-12 flex items-center justify-between">
          {state.manageCategory === 'Template' ? <div className="flex items-center gap-2">
            ...
            <i data-id="contract-wizard-edit-icon" className={`${showEditModal ? 'fas fa-lock ml-2' : " ml-2 fas fa-edit"}`} onClick={() => setShowEditModal(!showEditModal)}></i>
          </div> : <div className="w-1/2"></div>}
          <ContractTagSelector switching={switching} />
        </div>

        <div data-id="contract-wizard-container mx-auto px-4" className="col-12 col-lg-3">
          <div data-id="contract-wizard-settings-container mx-auto px-4" className="border rounded p-3 h-full">
            <div className="mb-3">
            ...
            <div className="mb-3">
              <div data-id="contract-wizard-features-title" className="uppercase small fw-semibold mb-2">Features</div>
            ...
            <div className="mb-3">
              <div className="uppercase small fw-semibold mb-2">Access control</div>
              <div className="form-check mb-1">
            ...
            <div className="mb-3">
              <div className="uppercase small fw-semibold mb-2">Upgradability</div>
              <div className="form-check mb-1">
        ...
        <div className="col-12 col-lg-9">
          <div className="border rounded p-0 h-full">
            ...
            />
            <div className="flex mt-5 justify-between items-center gap-3 mb-2">
              {state.manageCategory === 'Template' ? <div className="form-check ml-2">
                <>
              ...
              <button data-id="contract-wizard-validate-workspace-button" className="inline-flex items-center px-4 py-2 bg-primary text-white rounded-md hover:bg-primary/90 transition-colors btn-sm mr-2 justify-end" disabled={state.creating} onClick={async () => {
              ...
              >
                {state.creating ? <><i className="fas fa-spinner fa-spin mr-2"></i>Creating...</> : <><i className="far fa-check mr-2"></i>{state.manageCategory === 'Files' ? 'Create contract file' : 'Create workspace'}</>}
              </button>
            </div>
          </div>
        </div>
