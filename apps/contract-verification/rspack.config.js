// Standalone Rspack pilot config for apps/contract-verification.
// Stage D position 8 — the cool-down app: proven idioms (full node-polyfill fallback, node.global,
// externals.solc) plus a cosmetic custom output filename scheme. The webpack config carries a dead
// unused `versionData` object (no emit plugin consumes it) — intentionally not ported.
